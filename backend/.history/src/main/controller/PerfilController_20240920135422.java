...
public class PerfilController {
    ...
    public ResponseEntity<Usuario> perfilUsuario() {
        // Supondo que o usuário já esteja autenticado e você tenha os dados do usuário no contexto de segurança.
        // O nome do usuário seria buscado a partir da autenticação.

        Usuario usuario = usuarioService.obterUsuarioAutenticado(); // Pega o usuário autenticado
